...
public class MyCalculatorForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setToolTipText("First operand");

        jTextField2.setToolTipText("Second operand");

        jTextField3.setToolTipText("Result");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // parseInt is a static method on Integer
        int operand1 = Integer.parseInt(jTextField1.getText());
        int operand2 = Integer.parseInt(jTextField2.getText());
        int result = operand1 + operand2;
        
        jTextField3.setText("Result is " + result);
