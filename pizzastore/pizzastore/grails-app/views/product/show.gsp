    ...
    <ol class="property-list product">
        ...
        <g:if test="${productInstance?.description}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${productInstance}"
        ...
        <g:if test="${productInstance?.status}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="status-label"><g:fieldValue bean="${productInstance}"
                                                                                          field="status"/></span>
        ...
        <g:if test="${productInstance?.tags}">
            <li class="fieldcontain">
                <span id="tags-label" class="property-label"><g:message code="product.tags.label"
                                                                        default="Tags"/></span>
