...
class gsp_pizzastore_productedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',33,['bean':(productInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',35,['bean':(productInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',37,['name':("version"),'value':(productInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',45,['url':([resource: productInstance, action: 'update']),'method':("PUT")],2)
printHtmlPart(24)
})
...
public static final long LAST_MODIFIED = 1417354145000L
