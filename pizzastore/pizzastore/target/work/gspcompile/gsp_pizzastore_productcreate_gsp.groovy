...
class gsp_pizzastore_productcreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',30,['bean':(productInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',32,['bean':(productInstance)],2)
printHtmlPart(1)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',41,['url':([resource: productInstance, action: 'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1417354271000L
